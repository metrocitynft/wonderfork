...
function Calculator() {
    ...
    const [samznAmount, setSamznAmount] = useState(trimmedSamznBalance);
    ...
    const calcInitialInvestment = () => {
        const samzn = Number(samznAmount) || 0;
        const price = parseFloat(priceAtPurchase) || 0;
        const amount = samzn * price;
    ...
    }, [days, rewardYield, futureMarketPrice, samznAmount]);
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <div className="calculator-card-index">
                                            ...
                                            <p className="calculator-card-metrics-value">{isAppLoading ? <Skeleton width="100px" /> : <>{trimmedSamznBalance} MEMO</>}</p>
                                        </div>
                                    </Grid>
                                </Grid>
                            </div>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <div className="calculator-card-action-area-inp-wrap">
                                                ...
                                                <OutlinedInput
                                                    ...
                                                    value={samznAmount}
                                                    onChange={e => setSamznAmount(e.target.value)}
                                                    labelWidth={0}
                                                    endAdornment={
                                                        <InputAdornment position="end">
                                                            <div onClick={() => setSamznAmount(trimmedSamznBalance)} className="stake-card-action-input-btn">
                                                                <p>Max</p>
                                                            </div>
                                                        </InputAdornment>
                                                    }
