...
interface IAMZNERC20 is IERC20Mintable, IERC20 {
...
contract AmznTreasury is Ownable {
    ...
    IAMZNERC20 public immutable Amzn;
    ...
    function incurDebt( uint _amount, address _token ) external {
        ...
        uint maximumDebt = Samazon.balanceOf( msg.sender ); // Can only borrow against sOHM held
    ...
    /**
        ...
        @param _amount uint
     */
    function repayDebtWithAmzn( uint _amount ) external {
