...
contract AmznStaking is Ownable {
    ...
    using SafeERC20 for ISamzn;

    IERC20 public immutable Amzn;
    ISamzn public immutable Samazon;
    ...
    event LogForfeit(address indexed recipient, uint256 samznAmount, uint256 amznAmount);
    ...
    function stake( uint _amount, address _recipient ) external returns ( bool ) {
        ...
        Amzn.safeTransferFrom( msg.sender, address(this), _amount );
    ...
    function forfeit() external {
        ...
        uint samznBalance = Samazon.balanceForGons( info.gons );
        warmupContract.retrieve( address(this),  samznBalance);
        Amzn.safeTransfer( msg.sender, info.deposit);
        emit LogForfeit(msg.sender, samznBalance, info.deposit);
    }
    ...
    function unstake( uint _amount, bool _trigger ) external {
        ...
        Amzn.safeTransfer( msg.sender, _amount );
    ...
    function contractBalance() public view returns ( uint ) {
        return Amzn.balanceOf( address(this) ).add( totalBonus );
    }
